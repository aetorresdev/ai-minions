...
| Need | Command | Output |
|------|---------|--------|
| Interactive action loop (TTY) | `ai-minions tui` | Fullscreen Ink shell: Cerberus option C brand splash · guided launcher/runs/select/status/**live monitor**/evidence/attach/config/quit |
