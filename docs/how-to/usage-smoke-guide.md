...
Optional interactive loop (TTY): `ai-minions tui` — includes run selector + status pane (`s`); see [operator-cockpit-contract.md](../orchestrator/operator-cockpit-contract.md).
