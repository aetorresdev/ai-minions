...
Optional interactive loop (TTY): `ai-minions tui` — includes run selector + status pane (`s`) and evidence/attach pane (`e`); see [operator-cockpit-contract.md](../orchestrator/operator-cockpit-contract.md).
