...
- Pane/cockpit units: `operatorCockpitTui` · `operatorTuiShellFoundation` · `operatorGuidedLauncher` · `operatorTuiLiveMonitor` · `operatorRunSelectorTui` · `operatorEvidenceAttachPaneTui` · `operatorConfigReadinessPaneTui` · `operatorEvidenceTui` · `ink7FrameworkSpike`
