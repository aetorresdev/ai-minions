...
- **PR-boundary merge governance** — enforcement + `production_boundary_check` emission (depends on this doc; detailed spec lives in groomed backlog, not versioned in repo)
