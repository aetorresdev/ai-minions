...
Close the **evidence gate** before external usability beta (**v0.20.0-beta.1**): prove documented smoke paths work on minimum OS × provider × flow combinations, with trace / inspect / bundle artifacts — or record a **CERBERUS-approved exception**.
