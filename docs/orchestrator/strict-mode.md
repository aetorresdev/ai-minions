...
- **Dual suite:** `npm run test:e2e` then `npm run test:e2e:strict` — strict suite is **real-path** tests only; harness is `npm run test:e2e:strict:harness` if you need it.
