...
const MODULE_PATTERNS = [
  ...
  { id: "tools", patterns: [/^modules\/tools\//, /^security\/tool-eval/, /^security\/skill-registry/, /^security\/untrusted-context/, /^security\/context-authority-runtime-gate/, /^security\/load-tool-action-manifest/, /^mcp-client\.js$/] },
