...
function printOperatorCliHelp() {
  const lines = [
    ...
    "",
    "Runner TUI (launch) — highlights:",
    "  preflight / routing / run / status — model policy + orchestrator launch",
    "  trace / budget — read-only trace panels",
    "  worktree create|remove|list|status|contract|promote|promote-deny",
    "  run --worktree-isolated — bind run to isolated git worktree",
    "  Full flags: npm run runner:tui -- (no args) or see runner-tui-cli.js header",
    "",
