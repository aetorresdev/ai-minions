...
function printAiMinionsCliHelp() {
  const lines = [
    ...
    "  report     Read-only RUN_ANALYST markdown report (operator + management + CERBERUS input)",
    "  tui        Read-only evidence surface (stdout panels — no edits/approvals/reruns)",
    ...
    "",
    "Options (status / explain / result / evidence / context / resume / attach):",
    "  --run-id <id>            Task id / trace basename",
    ...
    "",
    "Install: node scripts/install-ai-minions.mjs (writes ~/.local/bin/ai-minions when PATH ok)",
    `Runner detail: ${DOCS_RUNNER}`,
