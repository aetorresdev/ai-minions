...
function printAiMinionsCliHelp() {
  const lines = [
    ...
    "  status     → npm run runner:tui -- status --run-id <id>",
    "  explain    → npm run explain-run -- --run-id <id>",
    ...
    "",
    "Alpha limitations:",
    "  - init/start only in this alpha slice; other commands fail with next_safe_action",
    "  - Existing scripts (run-orchestrator, runner:tui, install.sh) remain valid",
