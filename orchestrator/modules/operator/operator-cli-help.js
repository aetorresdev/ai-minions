...
function printAiMinionsCliHelp() {
  const lines = [
    ...
    "  doctor     → preflight + docs/orchestrator/pre-run-checklist.md",
    "  evidence   → npm run control-plane:tui -- --run-id <id>",
    ...
    "",
    "Alpha limitations:",
    "  - doctor/evidence/context/resume not wired yet; fail with next_safe_action",
