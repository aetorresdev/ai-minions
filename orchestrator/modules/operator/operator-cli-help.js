...
function printAiMinionsCliHelp(options = {}) {
  ...
  const lines = [
    ...
    `  ${cmd("tui")}        Interactive cockpit (TTY) or read-only evidence with --run-id/--latest/--file`,
    ...
    "",
    h("Alpha limitations:"),
    "  - Cockpit MVP is a TTY action loop — not production TUI / Web UI / fullscreen navigator",
    ...
    "",
    h("Options (tui):"),
    "  (no selector)            TTY: interactive cockpit (smoke/runs/status/attach/doctor/quit)",
